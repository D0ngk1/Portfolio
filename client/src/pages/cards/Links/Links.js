...
export default function Links(){
    const [isLinksHovered, setLinksHovered] = useState(false);
    ...
    return (
        <div className="links-container-wrapper">
            <div className='links-container'>
                <a  href='mailto: darylgzmn@gmail.com'> <i onMouseEnter = {() => handleMouseEnter()} className="fa fa-envelope fa-3x gmail-icon i-contacts" style={{ color: 'white' }}></i></a>
                <a  href='https://github.com/D0ngk1'> <i onMouseEnter = {() => handleMouseEnter()} className="fa fa-github fa-3x github-icon i-contacts" style={{ color: 'white' }}></i> </a>
                <a  href='https://www.linkedin.com/in/daryl-guzman-82556a256/'> <i onMouseEnter = {() => handleMouseEnter()} className="fa fa-linkedin fa-3x linkedin-icon i-contacts" style={{ color: 'white' }}></i> </a>
                    {/* LeetCode Icon (using custom SVG) */}
                <a href="https://leetcode.com/u/TheReal01/" target="_blank" rel="noopener noreferrer">
                    <svg onMouseEnter = {() => handleMouseEnter()} className='leetcode-icon i-contacts' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" color="blue" width="60" height="60" viewBox="0 0 16 16">
